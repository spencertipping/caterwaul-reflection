...
// Function scope.
// Determining function scope is not difficult in theory, but writing an efficient implementation is a bit of a challenge. The rules in Javascript are that any 'var' and any formal parameter
// create a variable scoped to that function. So, for example, function (x) {if (x) var y, z} has three local variables regardless of the value of x. (If x is falsy, then y and z are set to
// undefined; however, they're still scoped as function locals.)
// Generated by SDoc 
